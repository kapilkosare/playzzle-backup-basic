    ...
    <div className="container mx-auto py-8 px-4">
      <Card>
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          ...
          <p>
            Welcome to Piczzle ("we", "us", "our"). We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our application.
          </p>
